...
<?php
$page_title = "Sistem Pendataan Gudang";
...
<ul class="nav nav-tabs">
 <li ><a href="view-penjualanbarang.php">Penjualan</a></li>
  ...
  <li  class="active"><a href="view-barangrusakp.php">Barang Rusak</a></li>
</ul>
<!--Button Create Product-->
    
<div class="right-button-margin">
    <a href="tambah-barangrusak.php" class="btn btn-default pull-right">Tambah</a>
</div>
     ...
     while ($row = $stmt->fetch(PDO::FETCH_ASSOC))
    {
        ...
        echo '  <td>';
            //<!--Ubah dan Hapus button-->
             echo '<a href="update-barangrusak.php?id='.$id_barang_rusak.'" class="btn btn-default left-margin">Ubah</a>';
